...
if __name__ == '__main__':
    ...
    for i in range(n_output):
        with open("CGW-grader"+str(i)+".tsv") as graded_f:
            next(graded_f)
    ...
    for team in folder_list:
        with open(team+"/other.txt","w+") as f:
            ...
            print (team, "\t", total_grammaticality/total_sentences)
